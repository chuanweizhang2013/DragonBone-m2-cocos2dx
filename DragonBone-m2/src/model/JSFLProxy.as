package model
{
	...
	{
		public static const EXPORT_DIRECT:String = "exportDirect";
		...
		public static const GET_ITEM_ATTR:String = "getUIEditorAttrItem";
		public static const GET_ALL_ITEM_ATTR:String = "getUIEditorAllAttr";
		
		public static const SET_ITEM_ATTR:String = "setUIEditorAttrItem";
		...
		private static const JSFL_URL:String = "Bones/skeleton.jsfl";
		
		private static const MAX_SIZE:uint = 1024 * 35;
		
		
		public static const INIT_STAND:String = "initStand";
		public static const INIT_GUIDE:String = "initGuide";
		public static const INIT_UN_GUIDE:String = "initUnGuide";
		;
		...
		public function exoportDirect():void
		{
			
			runJSFLMethod(EXPORT_DIRECT, "dragonBones.exportDirect");
		}
		
		public function initStand():void
		{
			 
			runJSFLMethod(INIT_STAND, "dragonBones.initStand");
		}
		
		public function importDirect():void
		{
			
			runJSFLMethod(INIT_STAND, "dragonBones.importDirect");
		}
		...
		public function initGuide():void
		{
			...
			runJSFLMethod(INIT_GUIDE, "dragonBones.initGuide");
		}
		public function initUnGuide():void
		{
			
			runJSFLMethod(INIT_UN_GUIDE, "dragonBones.initunGuide");
		}
		...
		public function setMcAttr(armatureName:String,item:String, key:String,data:String):void
		{ 
			runJSFLMethod(SET_ITEM_ATTR, "dragonBones.setUIEditorAttr", armatureName, item, key,data);
		}
		public function getMcAttr(armatureName:String,item:String, key:String):void
		{ 
			runJSFLMethod(GET_ITEM_ATTR, "dragonBones.getUIEditorAttr", armatureName, item, key);
		}
		
		public function getAllMcAttr():void
		{ 
			runJSFLMethod(GET_ALL_ITEM_ATTR, "dragonBones.getUIEditorAllAttr");
		}
