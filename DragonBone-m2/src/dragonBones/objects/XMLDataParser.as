	...
	*/
	...
	public class XMLDataParser
	{
		...
		private static function parseDisplayData(displayXML:XML, displayData:DisplayData):void
		{
			...
			displayData.width = Number(displayXML.attribute(ConstValues.A_WIDTH));
			displayData.height = Number(displayXML.attribute(ConstValues.A_HEIGHT));
			
			displayData.text = displayXML.attribute(ConstValues.A_TEXT); 
			displayData.color= displayXML.attribute(ConstValues.A_FONT_COLOR); 
			displayData.align= displayXML.attribute(ConstValues.A_FONT_ALIGN);
			displayData.size = Number(displayXML.attribute(ConstValues.A_FONT_SIZE)); 
